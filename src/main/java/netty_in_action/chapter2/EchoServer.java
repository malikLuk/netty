/**
 *
 * Зматутим сам сервер. Он включает в себя:
 ...
 * предназначенныйдля доставки данных. Интрнет базируется на TCP-транспортировке. НИО-транспортировка почти идентична
